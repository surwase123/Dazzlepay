	...
	<div class="flex-grow-1">
		<div class="h-100 d-md-flex align-items-center auth-side-img">
			<div class="col-sm-10 auth-content w-auto">
				...
				<h4 class="text-white font-weight-normal">Change your account password and make your self more securely MPLS Dashboard.<br/>Do not forget to play with live customizer</h4>
			</div>
		</div>
		<div class="auth-side-form">
			<div class=" auth-content">
				...
				<div class="input-group mb-4">
					...
					<input type="text" class="form-control" placeholder="Mobile Number" maxlength="10" name="loginId" id="loginId"/>
				</div>
				...
				<button class="btn btn-block btn-primary mb-4" type="button" onclick="resetPassword()">Reset password</button>
			</div>
		</div>
	</div>
</div>
