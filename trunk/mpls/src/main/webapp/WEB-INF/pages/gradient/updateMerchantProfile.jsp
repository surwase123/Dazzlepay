...
<body class="">
	...
	<div class="pcoded-main-container">
					...
					<div class="row align-items-center">
						<div class="col-md-12">
							...
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="${applicationScope['baseUrl']}/merchant/profile/update">Merchant Registration</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<c:if test="${action == 'update'}">
								<c:set value="${applicationScope['baseUrl']}/merchant/profile/edit" var="actionUrl" />
							</c:if>
							<form id="merchantRegistration-form" method="post" action="${actionUrl}" onsubmit="return validateMerchantForm()">
								<c:if test="${action == 'update'}">	
									<div class="col-md-12">
								...
								<div class="col-md-12 column">
									...
									<div class="form-group">
										<div class="checkbox checkbox-primary d-inline">
											<input type="checkbox" name="termsCondition" id="termsCondition" disabled="" checked="checked">
									...
									<c:if test="${sessionScope.loginDTO.groupDTO.groupType == 'admin' || sessionScope.loginDTO.groupDTO.groupType == 'merchant'}">
										<div class="col-md-12">
	    ...
	    var fieldLength = "${fn:length(merchantAddressList)}";var isSuccess = "";var action = "${action}";var sessionId = "${r:toHexDecimal(pageContext.session.id)}";var ks = "${aes.keySize}";var ic = "${aes.iterationCount}";</script>
</body>
</html>
