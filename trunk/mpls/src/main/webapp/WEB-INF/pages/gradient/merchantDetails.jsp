		...
		<div class="user-about-block m-0">
			<div class="row">
				...
				<div class="col-md-8 mt-md-4">
					<div class="row">
						<div class="col-md-6">
							<a href="mailto:demo@domain.com" class="mb-1 text-muted d-flex align-items-end text-h-primary"><i class="feather icon-mail mr-2 f-18"></i>${merchant.emailId}</a>
					...
					<div class="card-body d-flex align-items-center justify-content-between">
						...
						<div class="card-body border-top pro-det-edit collapse show" id="pro-det-edit-1">
							<div class="form-group row">
								...
								<div class="col-sm-9">${merchant.merchantId}</div>
							</div>
							<div class="form-group row">
