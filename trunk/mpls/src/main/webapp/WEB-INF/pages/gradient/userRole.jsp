                            ...
                            <form id="userRole-form" action="${actionUrl}" method="post">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="accordion" id="accordionExample">
                                            <c:forEach items="${sessionScope.loginDTO.menuList}" var="menu" varStatus="index">
                                                ...
                                                <c:if test="${!empty(menu.userRoleMenuList)}">
                                                        <div class="card">
                                                            ...
                                                            <div id="collapse${index.count}" class="card-body collapse ${show}" aria-labelledby="headingOne${index.count}" data-parent="#accordionExample">
                                                                <c:forEach items="${menu.userRoleMenuList}" var="subMenu">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
