    		...
    		<div class="">
	            <div class="page-block">
	                ...
	                <input type="hidden" name="merchantId" id="merchantId" value="${sessionScope.loginDTO.merchant.id}" />
                        <div class="col-md-12">
                            <div id="reportrange" class="form-control col-md-3 row-dropDown marginBottom25 AdminDateRangePicker" onchange="getMerchantDashaboardData()">
			...
			<%-- order-card start --%>
			    ...
			    <div class="col-md-6 col-xl-4">
			     ...
			     <div class="col-md-6 col-xl-4">
			        <div class="card bg-c-red order-card">
			            <div class="card-body merchantDashboardCard">
			                <h6 class="text-white" style="font-size:16px">Loyalty Cards Status</h6><br>
			                <p class="m-b-0" style="font-size:16px">Total Loyalty Cards<br><span class="float-right"> ${loyaltyCardStatus.total}</span></p><br>
			                <p class="m-b-0" style="font-size:16px">Allocated Loyalty Cards<span class="float-right"> ${loyaltyCardStatus.allocated}</span></p>
			            	<p class="m-b-0" style="font-size:16px">Available Loyalty Cards<span class="float-right">${loyaltyCardStatus.availble}</span></p>
			            </div>
			        </div>
			    </div>
			    </div>
			                    ...
			                    <div class="card bg-c-red notification-card">
			                        <div class="card-body">
			                            <div class="row align-items-center">
			                                ...
			                                <div class="col-8 notify-cont">
			                                    <p><a class="text-white" onclick="searchCustomerForPayBill()">Pay Money</a></p>
			                                </div>
			                            </div>
			                        </div>
			                    </div>
			                    ...
			                    <div class="card bg-c-blue notification-card">
			                        <div class="card-body">
			                            <div class="row align-items-center">
			                                ...
			                                <div class="col-8 notify-cont">
			                                    <p><a class="text-white" onclick="searchCustomerForRefund()">Refund Money</a></p>
			                                </div>
			                            </div>
			                        </div>
			                    </div>
...
<%@include file="searchCustomer.jsp"%>
<%@include file="searchCustomerForPayBill.jsp"%>
<%@include file="searchCustomerRefund.jsp"%>
<%@include file="qrCodeModal.jsp"%>
...
<script src="${applicationScope['jsBaseUrl']}/javascript/mpls-dashboard.js" defer onload="loadPageScript()"></script>
</body>
</html>