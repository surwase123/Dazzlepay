    ...
    <div class="col-md-6 col-xl-3">
        <div class="card bg-c-blue order-card">
            <div class="card-body merchantDashboardCard">
                 ...
                 <p class="m-b-0" style="font-size:14px">Merchant as of now<span class="float-right">${adminDashboardData.totalMerchant}</span></p><br>
                 <p class="m-b-0" style="font-size:14px">Active Merchant<br>(in 7 days)<span class="float-right">${adminDashboardData.activeMerchantCount}</span></p>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-xl-3">
        <div class="card bg-c-green order-card">
            <div class="card-body merchantDashboardCard">
                ...
                <p class="m-b-0" style="font-size:14px">Customer as of now<span class="float-right">${adminDashboardData.totalCustomer}</span></p><br>
                <p class="m-b-0" style="font-size:14px">Active Customer<br>(in 7 days)<span class="float-right">${adminDashboardData.activeCustomerCount}</span></p>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-xl-3">
